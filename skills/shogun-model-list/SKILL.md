...
description: >
  ...
  "model overview", "available models", "show models"
---
...
- "Show me all models" / "model overview"
...
| Karo (Manager) | `claude-opus-4-6` | L4-L6 | Task orchestration with full strategic reasoning |
